messages = {
	...
	<ul>
		...
		<li><strong>Add images</strong> - will add images into the album you are currantly located in.</li>
		<li><strong>Move</strong> - will move an item. Highlight one or more items, click Move, browse to the desired destination and confirm the move with the Yes button.</li>
		<li><strong>Rename</strong> - will rename or edit the description for an item.</li>
		<li><strong>Permissions</strong> - will edit album permissions. You may edit permissions for albums recursively (subalbums will gain the same permissions as the selected album).</li>
		<li><strong>Manage users</strong> - add/edit album users that only has permission to view albums (not log into B3 itself).</li>
		<li><strong>Delete</strong> - delete albums or photos.</li>	
	</ul>
	",
